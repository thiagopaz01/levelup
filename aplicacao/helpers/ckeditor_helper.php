...
function addNewEditor($nome, $texto,$id=null,$height=500,$width=651)
{
	echo "<p>
	<label for='$nome' class='bigName'>$id:</label></p><p>";
	...
	$ckeditor->basePath = base_url("conteudo/ckeditor") . "/";
	$ckeditor->config['height'] = $height;
	$ckeditor->config['width'] = $width;
	//CKFinder::SetupCKEditor($ckeditor, '/ckfinder/');
	//CKFinder::SetupCKEditor($ckeditor, 'ckeditor/ckfinder');
	$ckeditor->editor($nome, $texto,$config);
}