...
class ImgCrop {
	 ...
	 * @return void
	*/
	public function ImgCrop( $origem = '', $extensoes_validas = array( 'jpg', 'jpeg', 'jpe', 'gif', 'bmp', 'png' ) ) 
	{
...
function crop_imagem($caminho_imagem,$caminho_nova,$largura,$altura)
{
    $novaImagem = new ImgCrop($caminho_imagem);
    $novaImagem->redimensiona($largura,$altura,'crop'); 
    $novaImagem->grava($caminho_nova); 
}
?>