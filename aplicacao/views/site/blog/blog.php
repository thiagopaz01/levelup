...
<div id="content-wrapper">
	...
	*/
	...
	$targetpage = base_url() . "blog/lista"; 	//your file name  (the name of this file)
	...
	*/
	...
	if($lastpage > 1)
	{	
		$pagination .= "<div class=\"wp-pagenavi text-align-center\">";
		//previous button
		$pagination .="<span class=\"pages\">página $page de $lastpage</span>";
		if ($page > 1) 
			$pagination.= "<a href=\"$targetpage/$prev\">&larr;</a> ";	
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= "<a href=\"$targetpage/$next\">&rarr;</a>";
		$pagination.= "</div>\n";		
	}
?>
<?=$pagination?>
