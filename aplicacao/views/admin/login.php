...
<div class="col_12" id="login">
       ...
       -->
       <div><img src="admin/images/logo.png" alt="Logo"></div>
       
       <?php if(isset($msg) && is_object($msg)) echo $msg->mensagem();?>
       <?php echo form_open("adm/logar",'class="vertical" id="form-login"')?>
       		<label for='txtNome'>E-mail</label>
	     	<input id='txtLogin' name='txtLogin' type='text' class="required">
            
            <label for='txtSenha'>Senha</label>
	     	<input id='txtSenha' name='txtSenha' type='password' class="required">
            
            <button type="submit" class="button green" >entrar</button>   
            <a href="<?php echo base_url('adm/esqueci_senha'); ?>" class="right">Esqueci minha senha</a>
